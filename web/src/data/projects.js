export const projects = [
  {
    ...
    description:
      'DomainFlow orchestrates multiple Large Language Models (GPT-4o & Gemini 1.5) to transform high-level project descriptions into structured domain models, interactive UML diagrams, and comprehensive use case specifications. The application follows a Layered Monolithic Architecture designed for high data integrity and complex relationship management.',
    bullets: [
    ...
    tech: ['React', 'Vite', 'Material-UI', 'Konva.js', 'Node.js', 'Express', 'MySQL', 'AWS RDS', 'OpenAI GPT-4o', 'Google Gemini 1.5 Pro', 'JWT', 'Redis'],
    links: { github: '', live: '' },
    cover: '',
  },
  {
    ...
    description:
      'Stayora is a real-time analytics platform deployed for luxury hotels (CHF 45M+ revenue). It ingests operational data to provide role-specific dashboards and features a "Text-to-SQL" engine that allows non-technical staff to query complex datasets using natural language. The system utilizes a Hybrid Microservices Architecture to separate business logic from heavy computation.',
    bullets: [
  ...
  },
  {
    ...
    description:
      'A scalable, containerized microservices platform for safely executing code (Python, Go, JS) in isolated environments. Built with Node.js, Go, and Docker-on-Docker orchestration, featuring a real-time job queue powered by Redis and MongoDB. The system utilizes a distributed Producer-Consumer architecture to handle high concurrency and ensure isolation.',
    bullets: [
